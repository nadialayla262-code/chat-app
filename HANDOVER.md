...
5. **Homei with the real model.** `ollama list` should show `qwen3:4b`.
...
- Retrieval over the corpus (embeddings) is not joined to the spine. That
  is still the one genuine hole in the stack.
